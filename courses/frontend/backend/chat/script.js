...
// *** التغيير الأساسي هنا: اسم الكوليكشن الجديد ***
const CHAT_COLLECTION = 'backend-chat'; 
...
async function checkUserProfile(user) {
    try {
        // ملاحظة: احتفظت ببروفايلات المستخدمين مشتركة (user-profiles)
        // حتى إذا دخل المستخدم شات الفرونت اند سابقاً، لا يحتاج لعمل Setup مرة أخرى هنا.
